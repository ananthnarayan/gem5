...
if [ -e ./merkle/input_gen.txt ]; then
	...
	python3 ./merkle/InputGen.py --file-size=1000
...
build/X86/$gem5  configs/example/se.py --cpu-type=DerivO3CPU --cpu-clock=1GHz --caches --l2cache --l1d_size=$cachesize --l1i_size=$cachesize --l2_size=$l2_size --l1d_assoc=4 --l1i_assoc=4 --l2_assoc=8 --mem-size=4GB --coherence-granularity=64B --mem-type=DDR3_1600_8x8 -c merkle_ddr -o "./merkle/input_gen.txt $blocksize" > ./m5out/outputlog_ddr.txt 2>./m5out/errlog_ddr.txt
...
build/X86/$gem5  configs/example/se.py --cpu-type=DerivO3CPU --cpu-clock=1GHz --caches --l2cache --l1d_size=$cachesize --l1i_size=$cachesize --l2_size=$l2_size --l1d_assoc=4 --l1i_assoc=4 --l2_assoc=8 --mem-size=4GB --coherence-granularity=64B --mem-type=HMC_2500_1x32 -c merkle_pim -o "./merkle/input_gen.txt $blocksize" > ./m5out/outputlog_pim.txt 2>./m5out/errlog_pim.txt
